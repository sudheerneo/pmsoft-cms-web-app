...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
  ...
  <div id="page"> 
    ...
    <div id="header-wrap"> 
      <div id="header"> 
        <div id="logo-section">qdPM 9.1 Installation</div>                  
      </div> 
    </div> 
  ...
  <div id="footer-wrap"> 
    ...
    <div id="footer"> 
      <div class="footer-text">       
        <br>
        qdPM 9.1 <br>      
       Copyright @ 2010 <a title="Project Management, Time Tracking, Support Tickets" class="footer-text" target="_blank" href="http://www.sudheerinfo.com/">Sudheer Software Development services</a>
